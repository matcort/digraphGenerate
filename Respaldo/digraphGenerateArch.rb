	...
	#				end
			...
			when 6
				if @pila.size>1
					...
					if @nodeId > 20 and @snodes >5 #si genera mas de 25 nodos aceptamos el archivo, sino lo borramos
							Dir.mkdir(@nameDir) unless File.exists?(@nameDir)
							...
							File.delete("grafGenerate.graphml")
							print "Generación desechada \n"
...
digrafo = DigraphGenerate.new("nombreAr")  
